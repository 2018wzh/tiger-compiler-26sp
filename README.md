...
docker run -it --privileged -p 2222:22 -v $(pwd):/home/stu/tiger-compiler lyf726/tiger-compiler-env:latest  # or make docker-run
```
...
docker run -it --privileged -p 2222:22 \
    -v $(pwd):/home/stu/tiger-compiler lyf726/tiger-compiler-env:latest  # or `make docker-run`
# Or run container in the backend and attach to it later
docker run -dt --privileged -p 2222:22 \
    -v $(pwd):/home/stu/tiger-compiler lyf726/tiger-compiler-env:latest
